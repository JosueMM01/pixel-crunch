...
PNG transparente es la salida del motor. La interfaz permite descargar PNG o WebP y valida el MIME real del encoder. Al codificar WebP limpia color residual en píxeles prácticamente transparentes para evitar manchas en generadores de miniaturas. **Original** conserva dimensiones; **Equilibrado** limita el lado mayor a 4096 px y es la opción recomendada; **Ligero** limita a 2048 px para priorizar estabilidad móvil. Las opciones limitadas nunca amplían una imagen.
